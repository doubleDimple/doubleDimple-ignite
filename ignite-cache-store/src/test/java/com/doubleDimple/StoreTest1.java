...
import com.doubledimple.ignite.ignitecache.config.ignite.IgniteCacheCfg;
...
public class StoreTest1 {
    ...
    private static final String PRODUCT_CACHE_NAME = StoreTest1.class.getSimpleName() + "-product";
